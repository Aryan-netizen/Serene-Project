...
function Product() {
  return (
    <div className="w-full sm:h-[110vh] h-[115vh] bg-gray-400 px-10 py-30">
        <h1 className="text-7xl text-center font-bold mb-10">Our Product</h1>
      <div className="w-4/5 flex mx-auto flex-col sm:flex-row gap-8 sm:gap-0 text-center sm:text-left just">
        ...
        <div className="sm:w-1/2 w-full h-[50vh] sm:px-10  rounded-lg overflow-hidden">
          <img
            ...
            src="https://images.unsplash.com/photo-1625470496744-a01bf36a262f?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt=""
          />
        </div>
      </div>
